...
$url_path = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http" /*http*/)."://"; 
...
$config['backend_url'] = $config['base_url'].$config['admin_url'].'/';
...
|
*/
$config['encryption_key'] = 'd3samadrapam2';
...
$config['sess_cookie_name'] = 'de3sdlmapwr';
